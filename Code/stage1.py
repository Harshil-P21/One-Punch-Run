...
####################################################################### MAKING CRAB (DEFINING)
        
class enemy(object):
    walkRight = [pygame.image.load('crab1r.png'),pygame.image.load('crab2r.png'),pygame.image.load('crab3r.png'),pygame.image.load('crab4r.png')]
    walkLeft = [pygame.image.load('crab1l.png'),pygame.image.load('crab2l.png'),pygame.image.load('crab3l.png'),pygame.image.load('crab4l.png')]
...
man = player(1, 410, 64,64)
crab= enemy (100, 410, 64, 64, 450)
...
while run:
    ...
    if crab.visible == True:
        if man.hitbox[1] < crab.hitbox[1] + crab.hitbox[3] and man.hitbox[1] + man.hitbox[3] > crab.hitbox[1]:
            if man.hitbox[0] + man.hitbox[2] > crab.hitbox[0] and man.hitbox[0] < crab.hitbox[0] + crab.hitbox[2]:
                man.hit()
                score -= 5
    if shoot > 0:
        shoot +=1
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            run = False
    for bullet in bullets:        
        if bullet.y - bullet.radius < crab.hitbox[1] + crab.hitbox[3] and bullet.y +bullet.radius > crab.hitbox[1]:
            if bullet.x + bullet.radius > crab.hitbox[0] and bullet.x - bullet.radius < crab.hitbox[0] + crab.hitbox[2]:
                if crab.visible == True:
                    hitsound.play()
                    crab.hit()
                    score += 1
